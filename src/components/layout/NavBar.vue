                            ...
                            <div class="row">
                                  ...
                                  <div class="home-showcase__image">
                                    ...
                                    <div class="home-showcase__buttons">
                                      <a
                                        ...
                                        >Multi Page <span class="fas fa-arrow-right"></span
                                      ></a>
                                      <a
                                        href="index-one-page.html"
                                        class="thm-btn home-showcase__buttons__item"
                                        >One Page <span class="fas fa-arrow-right"></span
                                      ></a>
                                    </div>
                              ...
                              <div class="col-lg-3">
                                <div class="home-showcase__item">
                                  ...
                                  <!-- /.home-showcase__image -->
                                  <h3 class="home-showcase__title">Home Page 03</h3>
                                  <!-- /.home-showcase__title -->
                                </div>
                                <!-- /.home-showcase__item -->
                              </div>
                                  ...
                                  <div class="home-showcase__image">
                                    ...
                                    <div class="home-showcase__buttons">
                                      <a
                                        ...
                                        class="thm-btn home-showcase__buttons__item"
                                        >View Page <span class="fas fa-arrow-right"></span
                                      ></a>
                                    </div>
                                    <!-- /.home-showcase__buttons -->
                                  </div>
                                  <!-- /.home-showcase__image -->
                                  <h3 class="home-showcase__title">Home Page 04</h3>
                                  <!-- /.home-showcase__title -->
                                </div>
                                <!-- /.home-showcase__item -->
                              </div>
